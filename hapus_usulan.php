...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        if ($del && $del1) {
            echo '<script>alert("Berhasil menghapus data."); document.location="lihat_usulan";</script>';
        } else {
            echo '<script>alert("Gagal menghapus data."); document.location="lihat_usulan";</script>';
        }
    } else {
        echo '<script>alert("ID tidak ditemukan di database."); document.location="lihat_usulan";</script>';
    }
} else {
    echo '<script>alert("ID tidak ditemukan di database."); document.location="lihat_usulan";</script>';
}
